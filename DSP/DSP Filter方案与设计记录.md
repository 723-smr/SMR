...
![](assets/DSP%20Filter方案与设计记录/file-20260121111744656.png)
那么在经过ZOH以后，添加了一个sinc包络，如下图所示：
![](assets/DSP%20Filter方案与设计记录/file-20260121111758769.png)
可见**高频部分被压制**了。随后，还需要用LPF，压制Sinc高频部分，这样的话（1）我上述随机序列的频谱，岂不是无法复原了？（2）为什么要用LPF压抑sinc包络？
**2. S**:
